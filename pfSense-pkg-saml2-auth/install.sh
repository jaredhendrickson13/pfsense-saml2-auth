...
cp -r "$BASEDIR/files/etc/inc/saml2_auth" "/etc/inc/"
...
# Copy static content
cp -r "$BASEDIR/files/usr/local/www/saml2_auth" "/usr/local/www/saml2_auth"
cp "$BASEDIR/files/usr/local/www/js/saml2_auth.js" "/usr/local/www/js/saml2_auth.js"
cp "$BASEDIR/files/usr/local/www/css/saml2_auth.css" "/usr/local/www/css/saml2_auth.css"